...
# Import all modules
from knapsack_gnn.data.generator import KnapsackGenerator, KnapsackSolver, create_datasets
...
def demo_single_instance():
    ...
    print(f"  Edge connectivity: bipartite (items <-> constraint)")
...
Examples:
  ...
  python evaluate.py --checkpoint_dir checkpoints/run_XXXXXX --visualize
    ...
    parser.add_argument('--demo', type=str, default='quick',
